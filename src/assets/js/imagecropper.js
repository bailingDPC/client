/*多尺寸 zc*/
// (function (i) {
    let imageCropper = function (a, b, d, e) {
        this.width = a;
        this.height = b;
        this.cropWidth = d;
        this.cropHeight = e;
    ...
    // i.ImageCropper = c;
    imageCropper.prototype.setCanvas = function (a) {
    ...
    imageCropper.prototype.addPreview = function (a) {
        this.previews.push((document.getElementById(a) || a).getContext("2d"))
    };
    imageCropper.prototype.loadImage = function (a) {
    ...
    imageCropper.prototype._init = function () {
        ...
        this.dragLeft = this.cropLeft + this.cropViewWidth;
        this.dragTop = this.cropTop + this.cropViewHeight;
        this._update();
        var b = this;
    ...
    imageCropper.prototype._mouseHandler = function (a) {
        if (a.type === "mousemove") {
            var b = this.canvas.getClientRects()[0];
            this.mouseX = a.pageX - b.left - document.documentElement.scrollLeft;
            this.mouseY = a.pageY - b.top - document.documentElement.scrollTop;
    ...
    imageCropper.prototype.rotate = function (a) {
        if (this.image) {
    ...
    imageCropper.prototype._drawRect = function (a, b, d, e, f, g, h) {
        this.context.save();
    ...
    imageCropper.prototype.getCroppedImageData = function (a, b, d) {
    ...
    imageCropper.prototype.isImage = function (a) {
